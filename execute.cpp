      ...
      case ALU:
         ...
         switch(add_ops) {
            ...
            case ALU_ADDR:
               ...
               setNegZero((signed)rf[alu.instr.addr.rd]);
               break;
            case ALU_SUBR:
               stats.numRegReads += 2;
               stats.numRegWrites++;
               ...
               setNegZero((signed)rf[alu.instr.subr.rd]);
               break;
            case ALU_ADD3I:
               stats.numRegReads++;
               stats.numRegWrites++;
               ...
               setNegZero((signed)rf[alu.instr.add3i.rd]);
               break;
            case ALU_SUB3I:
               stats.numRegReads++;
               stats.numRegWrites++;
               ...
               setNegZero((signed)rf[alu.instr.sub3i.rd]);
               break;
            case ALU_MOV:
               stats.numRegWrites++;
               rf.write(alu.instr.mov.rdn, alu.instr.mov.imm);
               setNegZero((signed)alu.instr.mov.imm);
            ...
            case ALU_ADD8I:
               ...
               setNegZero((signed)rf[alu.instr.add8i.rdn]);
               break;
            case ALU_SUB8I:
               stats.numRegReads++;
               stats.numRegWrites++;
               ...
               setNegZero((signed)rf[alu.instr.sub8i.rdn]);
               break;
            default:
      ...
      case SPECIAL:
         ...
         switch(sp_ops) {
            case SP_MOV:
               ...
               setNegZero(signed(rf[sp.instr.mov.rm]));
               break;
            case SP_ADD:
               stats.numRegReads += 2;
               stats.numRegWrites++;
